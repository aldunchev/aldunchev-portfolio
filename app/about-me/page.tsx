    ...
    <article>
      <section className="section section--divider">
        <div className="container">
          ...
          <p>
            Beyond coding, my ultimate goal is to deliver solutions that make
            clients happy and foster a team that takes pride in the work we
            create together.
          </p>
        </div>
      </section>
      ...
      <section className="section section--divider">
        <div className="container">
          ...
          <p>
            My journey started in 2013 as a back-end intern at ProPeople. But my
            passion was and still is frontend development, so I managed to
            transition into the front-end role.
          </p>
          <ul>
            <WorkItem
